...
def do_booking():
    info("Booking", "Thank you for booking with us today")
...
film_choice = Combo(app, options=["Star Wars", "Snow White", "Fargo"], grid=[1,0], align="left")
film_description = Text(app, text = "Which film?", grid=[0,0], align="left")
vip_seat = CheckBox(app, text="VIP seat?", grid=[1,1], align="left")
row_choice = ButtonGroup(app, options=[["Front", "F"], ["Middle", "M"], ["Back", "B"]], horizontal=True, grid=[1,2], align="left")
